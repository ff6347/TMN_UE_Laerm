...
public class Background implements Runnable {
	 ...
	 */
	private static float tinter;
	/**
	 * PDXIII background Stuff
	 */
	private static boolean tintBack = false;
	/**
	 * PDXIII background Stuff
	 */
	private static float tintMax = 60;
	/**
	 * PDXIII background Stuff
	 */
	private static float tintMin = 20;

	/**
	 * PDXIII background Stuff
	 */
	private static float tintSize = tintMax - tintMin;
